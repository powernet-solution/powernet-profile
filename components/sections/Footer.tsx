        ...
        <footer className="w-full">
            ...
            <div className="bg-white pt-20 pb-10 border-t border-gray-100">
                <div className="mx-auto px-6 md:px-10  max-w-screen-2xl">
                    <div className="flex flex-col lg:flex-row gap-6 md:gap-0 mb-16">
                        {/* LEFT */}
                        <div data-aos="fade-up" suppressHydrationWarning className="flex-1 w-fit lg:border-r lg:border-gray-200 md:mr-24">
                            ...
                            <div className="space-y-5 pl-5 font-medium text-2xl">
                                ...
                                <div className="flex items-start gap-4 w-full md:w-2/3 text-gray-700">
                        ...
                        <div data-aos="fade-up" data-aos-delay="100" suppressHydrationWarning className="flex-1 flex flex-wrap items-start justify-between gap-x-10 lg:gap-x-16 gap-y-10 lg:pl-12 text-base md:text-lg">
                            ...
                            <div className="w-fit">
                                ...
                                <ul className="space-y-4 font-medium text-gray-500">
                                    <li>
                                        <a href="https://www.instagram.com/powernet.id" className="hover:text-primary">
                                            Instagram
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://www.linkedin.com/company/powernetsolution/" className="hover:text-primary">
                                            LinkedIn
                                        </a>
                                    </li>
                                </ul>
